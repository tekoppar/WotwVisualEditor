...
{
    public partial class SeinVisualEditor : Form, InjectObject
    {
        static public SeinVisualEditor _Instance;

        private MemoryManager Memory { get; set; }
        private DllInjector DllInjector;
        private InjectCommunication _InjectCommunication;
        ...
        public static void Main(string[] args)
        {
            ...
            SeinVisualEditor editorWindow = new SeinVisualEditor();
            Application.Run(editorWindow);
        }

        public SeinVisualEditor(bool LoadSettings = true)
        {
            SeinVisualEditor._Instance = this;
            Application.EnableVisualStyles();
            ...
            this._InjectCommunication = new InjectCommunication(this);
            this.canStart = true;
            this.StartUpdateLoop();
            this.StartDLLCommunicationLoop();
        ...
        private void LoadInjector()
        {
            ...
            InjectCommunication._Instance.AddCall("CALL19PAR" + AppDomain.CurrentDomain.BaseDirectory);
        }
        ...
        private void DLLCommunicationLoop()
        {
            while (IsDisposingNow == false && this.DLLCommunication != null && Thread.CurrentThread.IsAlive)
            {
                try
                {
                    if (IsDisposingNow == false && InjectCommunication._Instance != null && InjectCommunication._Instance.StreamWriter != null)
                    {
                        UpdateDLLValues();
                    }
                }
        ...
        public void UpdateValues()
        {
            ...
            if (this.canStart == true && this.DllInjector == null)
        ...
        {
            var value = TE.GetPropertyObjectsByType(this.SeinVisualSettings, "SeinVisualSettings", typeof(TColorPicker));
        ...
        private void SeinVisualEditor_Resize(object sender, EventArgs e)
        {
